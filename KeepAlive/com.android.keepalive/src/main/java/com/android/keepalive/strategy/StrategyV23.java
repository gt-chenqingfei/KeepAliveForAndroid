 ...
 */
public class StrategyV23 implements IKeepAliveStrategy {
	...
	public void onDaemonAssistantCreate(final Context context, KeepAliveConfigurations configs) {
		Log.d("KeepAliveStrategy23", "onDaemonAssistantCreate");
		initAmsBinder();
	...
	public void onDaemonDead() {
		Log.d("KeepAliveStrategy23", "onDaemonDead");
