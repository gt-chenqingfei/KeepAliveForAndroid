...
public class SyncAccountUtils {
    ...
    public static void createSyncAccount(Context context) {
        ...
        Account account = GenericAccountService.GetAccount(KeepAliveApplication.getApp().getPackageName()+ACCOUNT_TYPE);
    ...
    public static void triggerRefresh() {
        ...
        ContentResolver.requestSync(
                GenericAccountService.GetAccount(KeepAliveApplication.getApp().getPackageName()+ACCOUNT_TYPE), // Sync account
