...
public class SyncAccountUtils {
    ...
    public static void createSyncAccount(Context context) {
        ...
        Account account = GenericAccountService.GetAccount(context.getPackageName() + ACCOUNT_TYPE, context);
    ...
    public static void triggerRefresh(Context context) {
        ...
        ContentResolver.requestSync(
                GenericAccountService.GetAccount(context.getPackageName() + ACCOUNT_TYPE, context), // Sync account
